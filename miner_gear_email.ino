...
const char* ssid = "Vidhula";        //SSID of Wifi network
const char* password = "vidumala01";   // Password of wifi network
...
String inputMessage = "vidhulaiyer.pallavor2020@vitstudent.ac.in";   //Reciepent email alert.
